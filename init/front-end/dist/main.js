...
// Module
var game_code = " <body> <section class=\"overflow-auto flex-grow-1 d-flex flex-column\"> <div class=\"container-fluid flex-grow-1\"> <main class=\"game-cmp\"> <div class=\"cards\"></div> </main> </div> </section> <" + "script>(new GameComponent).init()<" + "/script> </body> ";
// Exports
...
var score_code = " <body> <section class=\"overflow-auto flex-grow-1 d-flex flex-column\"> <div class=\"container-fluid flex-grow-1\"> <main class=\"score-cmp\"> <div class=\"d-flex p-3\"> <div class=\"flex-grow-1\"> <h3 class=\"congrats\">CONGRATS<br/><span id=\"name\"></span></h3> </div> <div> <img src=\"" + ___HTML_LOADER_REPLACEMENT_0___ + "\" class=\"happy\"/> <p class=\"size\"><span id=\"size\"></span> pairs</p> <p class=\"time\"><span id=\"time\"></span>s</p> </div> </div> </main> </div> </section> <" + "script>(new ScoreComponent).init()<" + "/script> </body> ";
// Exports
